    ...
    >
      ...
      <div class="card">
        <div v-if="!isProductAvailable" class="product-unavailable-container">
          <div class="overlay smile">
            <img src="../assets/bg-sad.svg" alt="background unavailable product" srcset="" />
          </div>
          <div class="product-details">
            <p>This product is unavailable to show</p>
            <div class="cta">
              <button type="button" @click="getSingleProduct()" class="cta-next">
                Next Product
              </button>
            </div>
          </div>
        ...
        <div v-else class="product-container">
          ...
          <div class="product-details">
            <div class="top">
              <h3
                :class="product.data.category === 'men\'s clothing' ? 'font-navy' : 'font-magenta'"
                class="title"
              >
                {{ product.data.title }}
              </h3>
              <div class="sub-title">
                ...
                <div class="rating">
                  ...
                  <div class="rating">
                    <span
                      :class="
                        product.data.category === 'men\'s clothing' ? 'bg-navy' : 'bg-magenta'
                      "
                      class="circle"
                    ></span>
                    <span
            ...
            <div class="bottom">
              ...
              <div class="cta">
                ...
                <button
                  type="button"
                  @click="getSingleProduct(), scrollToTop()"
                  :class="
                    product.data.category === 'men\'s clothing'
